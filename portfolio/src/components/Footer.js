...
const LinkedInIcon = ({ linkedInUrl }) => {
	return (
		<a href={linkedInUrl} target="_blank" rel="noreferrer">
			<svg className={`${styles['linkedInIcon']}`} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
...
const GitHubIcon = ({ gitHubUrl }) => {
	return (
		<a href={gitHubUrl} target="_blank" rel="noreferrer">
			<svg className={`${styles['gitHubIcon']}`} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
